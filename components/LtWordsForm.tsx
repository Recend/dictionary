...
function LtWordsForm(this: any, { onSubmit, defaultValues }: Props) {
  ...
  async function submitHandler() {
    ...
    try {
      const response = await fetch(
        'https://lt-zodynas-default-rtdb.firebaseio.com/words/' +
          inputs.word.value +
          '.json'
      );
  ...
  function addToFavoritesHandler() {
    ...
    wordsCtx.addToFavoritesLT(checkedWord, description, translation);
